...
function contains_973080262(s_973080263, sub_973080264) {
  var result_973080265 = false;

  var F = {procname: "strutils.contains", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
  BeforeRet: {
    F.line = 2117;
    result_973080265 = (0 <= nsuFindStr(s_973080263, sub_973080264, 0, -1));
    break BeforeRet;
  };
  framePtr = F.prev;

  return result_973080265;
...
function HEX3Aanonymous_956301378(r_956301379) {
  ...
  BeforeRet: {
    ...
    if (!(contains_973080262(cstrToNimstr(reason_956301345.message), [102,111,111,98,97,114,58,32,55]))) {
    F.line = 241;
